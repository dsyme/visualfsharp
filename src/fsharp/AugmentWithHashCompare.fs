...
let mkValSpec g (tcref: TyconRef) tmty vis slotsig methn ty argData = 
    ...
    Construct.NewVal (methn, m, None, ty, Immutable, true, topValInfo, vis, ValNotInRecScope, Some membInfo, NormalVal, [], inl, false, XmlDoc.Empty, true, false, false, false, false, false, None, Parent tcref) 
