...
open FSharp.Compiler.Syntax.Internal
open FSharp.Compiler.Text
open FSharp.Compiler.Text.Range

type FSharpSynTypar(x: SynTypar) =
    let (SynTypar(ident, staticReq, isCompGen)) = x

    member _.Id = ident
    member _.StaticReq = staticReq
    member _.IsCompilerGenerated = isCompGen
    member this.Range = this.Id.idRange
