...
type FSharpSynMeasure =
    ...
    | Var of typar: FSharpSynTypar * range: range

/// Represents an unchecked syntax tree of F# unit of measure exponents.
[<Class>]
type FSharpSynRationalConst =
...
type FSharpSynTyparDecl =
    | SynTyparDecl of attributes: SynAttributes * FSharpSynTypar

/// The unchecked abstract syntax tree of F# type constraints
[<Class>]
type FSharpSynTypeConstraint =

    /// F# syntax: is 'typar: struct
    | WhereTyparIsValueType of
        typar: FSharpSynTypar *
        range: range
...
type FSharpSynExpr =
    ...
    | TraitCall of
        supportTys: FSharpSynTypar list *
...
[<Class>]
type FSharpSynInterpolatedStringPart =
...
[<RequireQualifiedAccess>]
type FSharpSynSimplePatAlternativeIdInfo =
...
[<Class>]
type FSharpSynStaticOptimizationConstraint =
...
type FSharpSynAttributes = SynAttributeList list

/// Represents extra information about the declaration of a value
[<NoEquality; NoComparison>]
type FSharpSynValData =
    | SynValData of
...
[<NoEquality; NoComparison>]
type FSharpSynBindingReturnInfo =
...
/// or implementation.
[<Class>]
type FSharpSynTypeDefnSimpleRepr =
...
[<NoEquality; NoComparison>]
type FSharpSynExceptionDefnRepr =
...
type FSharpSynMemberDefns = SynMemberDefn list

/// Represents a definition within a module
[<NoEquality; NoComparison;RequireQualifiedAccess>]
type FSharpSynModuleDecl =
...
type FSharpSynModuleOrNamespaceKind =
...
[<NoEquality; NoComparison>]
type FSharpSynModuleOrNamespace =
...
[<NoEquality; NoComparison>]
type FSharpSynModuleOrNamespaceSig =
