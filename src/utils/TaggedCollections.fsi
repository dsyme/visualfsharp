...
type internal Set<'T, 'ComparerTag when 'ComparerTag :> IComparer<'T>> =
    ...
    member Partition : predicate:('T -> bool)
    ...
    static member Equality : Set<'T, 'ComparerTag> * Set<'T, 'ComparerTag>
         -> bool
    ...
    static member (-) : Set<'T, 'ComparerTag> * Set<'T, 'ComparerTag>
         -> Set<'T, 'ComparerTag>
    /// Compute the union of the two sets.
    static member (+) : Set<'T, 'ComparerTag> * Set<'T, 'ComparerTag>
         -> Set<'T, 'ComparerTag>
    /// Compute the intersection of the two sets.
    static member Intersection : Set<'T, 'ComparerTag> * Set<'T, 'ComparerTag>
         -> Set<'T, 'ComparerTag>
    /// Compute the union of the two sets.
    static member Union : Set<'T, 'ComparerTag> * Set<'T, 'ComparerTag>
         -> Set<'T, 'ComparerTag>
    /// Return a new set with the elements of the second set removed from the first.
    static member Difference : Set<'T, 'ComparerTag> * Set<'T, 'ComparerTag>
         -> Set<'T, 'ComparerTag>
...
type internal Map<'Key, 'Value, 'ComparerTag when 'ComparerTag :> IComparer<'Key>> =
    ...
    static member FromList : 'ComparerTag * ('Key * 'Value) list
    ...
    static member Create : 'ComparerTag * seq<'Key * 'Value>
         -> Map<'Key, 'Value, 'ComparerTag>
    ...
    member Fold : folder:('Key -> 'Value -> 'State -> 'State)
         -> 'State -> 'State
    ...
    member FoldSection : 'Key
         -> 'Key -> ('Key -> 'Value -> 'State -> 'State) -> 'State -> 'State
    /// Fold over the bindings in the map.  
    member FoldAndMap : ('Key -> 'Value -> 'State -> ('T * 'State))
    ...
    member Partition : ('Key -> 'Value -> bool)
         -> Map<'Key, 'Value, 'ComparerTag> * Map<'Key, 'Value, 'ComparerTag>
